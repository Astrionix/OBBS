			...
			<div class="agile-contact-form">
				<div class="col-md-6 contact-form-left">
					<div class="w3layouts-contact-form-top">
						<h3>Get in touch</h3>
						<p>Welcome to Utsav, your dedicated partner in creating unforgettable events. At Utsav, we specialize in transforming your vision into reality with our comprehensive event management services. Whether it’s a grand wedding, a corporate gala, a cultural festival, or an intimate gathering, Utsav ensures that every detail is meticulously planned and flawlessly executed.</p>
					</div>
